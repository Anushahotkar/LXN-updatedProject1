...
const platformIcons = {
  Facebook: (
    <svg width="24" height="24" fill="#1877F2" viewBox="0 0 24 24" aria-label="Facebook" className="inline-block mr-2">
  ...
  X: (
    <svg width="24" height="24" fill="#1DA1F2" viewBox="0 0 24 24" aria-label="X" className="inline-block mr-2">
  ...
  Instagram: (
    <svg width="24" height="24" fill="#C13584" viewBox="0 0 24 24" aria-label="Instagram" className="inline-block mr-2">
...
const SocialMediaPlanner = () => {
  const postsByDate = useMemo(() => groupPostsByDate(mockData.socialPosts), [mockData.socialPosts]);
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 dark:scrollbar-thumb-gray-700 dark:scrollbar-track-gray-800 max-w-full">
        <div
          className="
            grid
            grid-cols-1
            ...
            return (
              <div
                ...
                className="
                  ...
                  rounded-lg p-5 bg-white dark:bg-gray-800
                  shadow-sm hover:shadow-lg transition-shadow duration-300
                  min-w-0
                "
              >
                <div className="text-center font-semibold mb-5 border-b border-gray-300 dark:border-gray-600 pb-3">
                ...
                {posts.length === 0 ? (
                  <p className="text-gray-400 dark:text-gray-500 text-center mt-12">No posts</p>
                ) : (
                  posts.map((post) => (
                    <Card
                      key={post.id}
                      className="
                        mb-6 p-5 bg-gray-50 dark:bg-gray-700
                        rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300 cursor-pointer
                        flex flex-col
                      "
                    >
                      ...
                      <p className="text-sm mb-4 text-gray-800 dark:text-gray-200 flex-grow">{post.content}</p>
                      <p className="text-xs text-gray-600 dark:text-gray-400 mb-4">Audience: {post.audience}</p>
